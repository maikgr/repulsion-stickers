...
module.exports = {
    ...
    execute: async function (message, args) {
        ...
        embed.setFooter('Sticker Bot version 1.14.1')
            ...
            .addField('@Stickers#9966 update-url `[keyword]` `[url]`', 'Update a sticker\'s image using an url.')
            .addField('@Stickers#9966 update-image `[keyword]` `[attachment]`', 'Update a sticker\'s image using an image attachment.')
